...
#    endif
        ...
        TIM_TimeBaseStructure.TIM_Period = 0;     // set dummy value (don't set to 0), will be initialized later
        ...
        TIM_OC4PreloadConfig(IRSND_TIMER, TIM_OCPreload_Enable);
